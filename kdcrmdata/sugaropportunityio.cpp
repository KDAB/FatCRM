...
void SugarOpportunityIO::readOpportunity(SugarOpportunity &opportunity)
{
    ...
    while (xml.readNextStartElement()) {
        if (xml.name() == "id") {
            ...
            opportunity.setNextCallDate(KDCRMUtils::dateFromString(xml.readElementText()));
        } else {
...
bool SugarOpportunityIO::writeSugarOpportunity(const SugarOpportunity &opportunity, QIODevice *device)
{
    ...
    writer.writeTextElement(QString("nextCallDate"), KDCRMUtils::dateToString(opportunity.nextCallDate()));
