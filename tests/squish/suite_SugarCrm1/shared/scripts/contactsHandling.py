...
def registerDetails(dList):       
    ...
    type(waitForObject(":Details.assignedTo_QComboBox"), dList[7])
    if(dList[8] != ""):
         type(waitForObject(":Details.reportsTo_QComboBox"), dList[8]) 
    type(waitForObject(":Details.primaryEmail_QLineEdit"), dList[9])   
...
def checkDetailsValues(dList):    
    ...
    test.compare(findObject(":Details.assignedTo_QComboBox").currentText, dList[7])
    test.compare(findObject(":Details.reportsTo_QComboBox").currentText, dList[8]) 
    test.compare(findObject(":Details.primaryEmail_QLineEdit").text, dList[9])    
